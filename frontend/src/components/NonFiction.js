...
const NonFiction = ({ setCart, setWishlistItems }) => {
  const books = [
    { id: 6, image: book6, title: 'MASHIN ME', author: 'Author 6', rating: 4, price: '₹350', description: 'This is Book 6' },
    { id: 7, image: book7, title: 'ANOTINITY', author: 'Author 7', rating: 5, price: '₹499', description: 'This is Book 7' },
    ...
    { id: 10, image: book10, title: 'SPECTRUMB', author: 'Author 10', rating: 5, price: '₹450', description: 'This is Book 10' },
  ];
  ...
  return (
    <div className="top-books-container">
      <h2 className="section-title3">Local Non-fiction Bestsellers</h2>
